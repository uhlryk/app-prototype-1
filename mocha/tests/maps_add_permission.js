...
describe("Create maps permission test: ", function(){
	var server;
	...
	describe("add map permission test:", function(){
		var projectFirst;
		var leaderFirst;
		var adminFirst;
		var coworkerFirst;
		...
		describe("Project leader permission test:", function(){
			it("should not return 401 auth error, when adding map in own project", function(done){
			...
			it("should return 401 auth error, when adding map in other project", function(done){
				request.post(url + "/maps")
				.set('access-token', leaderFirst.token)
		...
		describe("Investor permission test:", function(){
			it("should return 401 auth error, when adding map in own project", function(done){
				request.post(url + "/maps")
